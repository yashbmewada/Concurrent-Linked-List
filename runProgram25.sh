...
#SBATCH -o YBM_25_%j.csv # output and error file name (%j=jobID) 
...
cd bin
java Main 25 250 # run the Java program  - Args [0] - Number of threads and Args[1] - Number of Bound on count
